...
import Pic5 from "../images/image1.png";
    ...
    return (
        <div style={{
            ...
            <div className='d-flex flex-column align-items-center position-relative'
                ...
                <img src={Pic5} alt="" style={{ marginBottom: "30px" }} />
                ...
                <div className='d-flex justify-content-center' style={{
                    ...
                    <Link to={selected === null ? "" : "/question3"} style={{ textDecoration: "none" }} onClick={() => handleAnswer(selected)} >
